...
if __name__ == '__main__':
    ...
    revista1 = Revista(211, 'TAMBWE', 'National Geographic', ' Gilbert H. Grosvenor', True, 4, 'Multiple Disciplines')
    estudiante = Estudiante(cedula="0956752182", nombre="Marcos", apellido="Bueno", email="antonioquinde31@gmail.com",telefono="0986231685", direccion="Coop. Sergio Toral",  numero_libros=1, activo=True, carrera="Gestión de la información gerencial")
    ...
    libro1 = Libro(101, 'Raimon Samsó', 'Alma gemela', True, 5)
    docente = Docente(cedula="0978346432", nombre="Ana", apellido="Vera", email="Ana.vera@gmail.com",telefono="0979551518", direccion="Urdesa",  numero_libros=3, activo=True, carrera="Psicologia", id_docente="DOC035", titulo_3er_nivel="Ph.D. En Psicologia", titulo_4to_nivel="")
